...
const userDemand = (e) => {
  if (e.key === "Enter" || e.type === "click") {
    if (domPositions.input.value !== "") {
      ...
      _data_manipulation__WEBPACK_IMPORTED_MODULE_0__.urls[1] = `http://api.openweathermap.org/geo/1.0/direct?q=${domPositions.input.value}&appid=03923b23af6d02daed9f1c90b95acfc8`;
